  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-secondary py-8 px-4">
      ...
      <div className="relative w-full max-w-screen-xl bg-white rounded shadow-lg p-6">
        <h2 className="text-2xl font-bold text-primary mb-4 text-center">Admin - Players View</h2>
        ...
        {/* Create/Edit Form */}
        <form onSubmit={handleCreateOrUpdate} className="mb-6 flex flex-col space-y-4 max-w-md mx-auto">
          <input
          ...
          <table className="min-w-full text-left border border-gray-300">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-2 border-b border-gray-300">University</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {players.map((player) => (
                <tr key={player.id} className="hover:bg-gray-50">
                  <td className="px-4 py-2 border-r border-gray-300">{player.id}</td>
                  <td className="px-4 py-2 border-r border-gray-300">{player.name}</td>
                  <td className="px-4 py-2 border-r border-gray-300">{player.university}</td>
                  <td className="px-4 py-2 border-r border-gray-300">{player.runs}</td>
                  <td className="px-4 py-2 border-r border-gray-300">{player.wickets}</td>
